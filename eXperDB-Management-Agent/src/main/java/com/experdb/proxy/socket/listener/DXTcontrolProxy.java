...
public class DXTcontrolProxy extends SocketCtl {
	...
	public void start() {
		...
		PryAgentInfoVO agtVo = new PryAgentInfoVO();

		context = new ClassPathXmlApplicationContext(new String[] {"context-tcontrol.xml"});
		ProxyServiceImpl service = (ProxyServiceImpl) context.getBean("ProxyService");
		SystemServiceImpl systemService = (SystemServiceImpl) context.getBean("PrySystemService");
		...
		try {
			...
			PryAgentInfoVO agentInfoVO = systemService.selectPryAgtInfo(agtVo);
