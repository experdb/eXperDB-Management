						...
						<form class="cmxform" name="ipadr_form_reg" id="ipadr_form_reg" method="post">
							<fieldset>
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" id="portno_reg" name=portno_reg  maxlength="5" onkeyup="fn_checkPort(this)" placeholder="5<spring:message code='message.msg188'/>">
									</div>
