				...
				<table class="write">
					...
					<tbody>
						<tr>
							...
							<td>
								<c:if test="${act == 'i'}">
								<input type="text" class="txt" name="cnr_nm" id="cnr_nm" value="${cnr_nm}" maxlength="20" style="width: 180px;" onkeyup="fn_checkWord(this,20)" placeholder="20<spring:message code='message.msg188'/>" onblur="this.value=this.value.trim()"/>
