...
<script type="text/javascript">
	 ...
	 ******************************************************** */
	function fn_kafka_change_IpPort_re(){
		$("#mod_trans_kafka_con_Chk", "#modTransKfkConRegForm").val("fail"); 
	}
						...
						<form class="cmxform" id="modTransKfkConRegForm">
							...
							<fieldset>
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="mod_trans_kafka_con_ip" name="mod_trans_kafka_con_ip" maxlength="50" placeholder='50<spring:message code='message.msg188'/>' onblur="this.value=this.value.trim()" onchange="fn_kafka_change_IpPort_re();" tabindex=1 />	
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control"  id="mod_trans_kafka_con_port" maxlength="5" name="mod_trans_kafka_con_port" onblur="this.value=this.value.trim()" placeholder='<spring:message code="eXperDB_scale.msg15" />' onKeyUp="chk_Number(this);" onchange="fn_kafka_change_IpPort_re();"  tabindex=2  />	
									</div>
								</div>																	
