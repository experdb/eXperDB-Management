 ...
 *  스키마 리스트 조회
 ******************************************************** */
function fn_schema_search(db_svr_id,db_nm){
					...
					<div class="view on addOption_inr" id="tab1">
						<ul>
							...
							<li>
								...
								<input type="text" class="txt" name="db_id" id="db_id" value="${db_nm}" readonly="readonly"/>
							</li>
							<li>
									...
									<div class="trans_mapping_lt" style="width:400px;">
										<p class="trans_tit"><spring:message code="data_transfer.tableList"/></p>
											...
											<table id=tableList  class="display" cellspacing="0" width="100%">
												<thead>
													<tr>
														<th style="width: 161px;min-width: 100px;" class="dt-center">스키마명</th>
														<th style="width: 162px;min-width: 100px;" class="dt-center">테이블명</th>
													</tr>
												</thead>
											</table>											
