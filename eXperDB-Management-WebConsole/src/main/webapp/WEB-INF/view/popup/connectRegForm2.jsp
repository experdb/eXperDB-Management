									...
									<div class="card-body">
										<form class="form-inline" onsubmit="return false">
											<div class="input-group mb-2 mr-sm-2">
												<input type="text" class="form-control form-control-xsm" style="width:400px;" maxlength="25" id="ins_table_nm" name="ins_table_nm" onblur="this.value=this.value.trim()" placeholder='<spring:message code="migration.table_name" />'/>				
											</div>
