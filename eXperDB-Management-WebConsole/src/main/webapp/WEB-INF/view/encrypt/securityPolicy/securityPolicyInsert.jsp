						...
						<div class="card" style="margin-bottom:0px;">
							...
							<div id="page_header_sub" class="collapse" role="tabpanel" aria-labelledby="page_header_div" data-parent="#accordion">
								<div class="card-body">
									<div class="row">
										<div class="col-12">
											<p class="mb-0"><spring:message code="encrypt_help.Security_Policy_Insert"/></p>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="form-group row div-form-margin-z" style="margin-top:10px;margin-bottom:-10px;">
						<div class="col-12" >
							<ul class="nav nav-pills nav-pills-setting nav-justified" id="server-tab" role="tablist" style="border:none;">
								<li class="nav-item">
									<a class="nav-link active" id="server-tab-1" data-toggle="pill" href="#insGeneral_InformationTab" role="tab" aria-controls="subTab-1" aria-selected="true"  >
										<spring:message code="encrypt_policy_management.General_Information"/>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="server-tab-2" data-toggle="pill" href="#insOptionTab" role="tab" aria-controls="subTab-2" aria-selected="false" >
										<spring:message code="encrypt_policy_management.Option"/>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="server-tab-3" data-toggle="pill" href="#insAccess_Control_PolicTab" role="tab" aria-controls="subTab-3" aria-selected="false" >
											...
											<fieldset>
												<div class="form-group row" style="margin-bottom:10px;">
													...
													<div class="col-sm-1">
														<div class="form-check">
															<label class="form-check-label">
																<input type="radio" class="form-check-input" name="defaultAccessAllowTrueFalse" id="rdo_2_2" value="N" > <spring:message code="agent_monitoring.no"/>														
															</label>
														</div>
													</div>
												</div>
