...
<div id="contents">
	<div class="contents_wrap">
		<div class="contents_tit">
			<h4><spring:message code="encrypt_policy_management.Security_Policy_Modify"/><a href="#n"><img src="/images/ico_tit.png" class="btn_info" /></a></h4>
			<div class="infobox">
				<ul>
					<li><spring:message code="encrypt_help.Security_Policy_Update"/></li>
				</ul>
			</div>
			<div class="location">
				<ul>
					...
					<li class="on"><spring:message code="encrypt_policy_management.Security_Policy_Modify"/></li>
				</ul>
			</div>
		</div>
		<div class="contents">
					...
					<table class="write">
						...
						<tbody>
							...
							<tr>
								...
								<td><textarea class="tbd1" name="profileNote" id="profileNote" maxlength="100" onkeyup="fn_checkWord(this,100)" placeholder="100<spring:message code='message.msg188'/>">${result.profileNote}</textarea></td>
							</tr>
						</tbody>
					</table>
				</div>
