...
<div id="contents">
	<div class="contents_wrap">
		<div class="contents_tit">
			<h4><spring:message code="encrypt_log_sever.Management_Server"/><a href="#n"><img src="../images/ico_tit.png" class="btn_info" /></a></h4>
			<div class="infobox">
				<ul>
					<li><spring:message code="encrypt_help.Management_Server"/></li>
				</ul>
			</div>
			<div class="location">
				<ul>
					...
					<li class="on"><spring:message code="encrypt_log_sever.Management_Server"/></li>
				</ul>
			</div>
		</div>
		<div class="contents">
