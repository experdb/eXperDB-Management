...
<%
	/**
	* @Class Name : sampleDatatableForm.jsp
	* @Description : Sample DatatableForm 화면
	...
	function fn_egov_save() {
		$.ajax({
			...
			success : function(result) {
				document.location.href = "sampleDatatableList.do";
			},
					...
					<table width="100%" border="1" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td class="tbtd_content"><textarea name="contents" rows="3"
									cols="80" class="contents"></textarea></td>
						</tr>
						<tr>
					...
					<table width="100%" border="1" cellpadding="0" cellspacing="0"
						...
						<c:forEach var="result" items="${result}" varStatus="status">
							...
							<tr>
								<td class="tbtd_caption">내용</td>
								<td class="tbtd_content"><textarea name="contents" rows="3"
										cols="80" class="contents">${result.contents}</textarea></td>
							</tr>
							<tr>
								<td class="tbtd_caption">등록자</td>
								<td class="tbtd_content"><input type="text" name="reg_nm"
			...
			<div id="sysbtn">
				<ul>
					<li><span class="btn_blue_l"> <a
							href="sampleDatatableList.do">목록</a> <img
