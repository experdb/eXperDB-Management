								...
								<div class="col-md-12 system-tlb-scroll" style="border:0px;height: 620px; overflow-x: hidden;  overflow-y: auto; ">
									<div class="card-body" style="border: 1px solid #adb5bd;">
										...
										<div class="form-group row div-form-margin-z" style="margin-bottom:-10px;">
											...
											<div class="col-sm-10">
												<textarea class="form-control" id="db2pg_trsf_wrk_exp" name="db2pg_trsf_wrk_exp" rows="2" maxlength="100" onkeyup="fn_checkWord(this,100)" placeholder="100<spring:message code='message.msg188'/>"></textarea>
											</div>
										</div>
									</div>
									<br/>
