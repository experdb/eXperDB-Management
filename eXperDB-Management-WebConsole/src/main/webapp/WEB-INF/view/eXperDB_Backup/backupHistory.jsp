								...
								<div class="row">
									<div class="col-5"  style="padding-top:3px;">
										<h6 class="mb-0">
											<a data-toggle="collapse" href="#page_header_sub" aria-expanded="false" aria-controls="page_header_sub" onclick="fn_profileChk('titleText')">
												...
												<span class="menu-title"><spring:message code="eXperDB_backup.msg26" /></span>
									...
									<div class="col-7">
					 					<ol class="mb-0 breadcrumb_main justify-content-end bg-info" >
											...
											<li class="breadcrumb-item_main active" style="font-size: 0.875rem;" aria-current="page"><spring:message code="eXperDB_backup.msg26" /></li>
										</ol>
									</div>
								</div>
							</div>
							...
							<form class="form-inline row">
								...
								<div class="input-group mb-2 mr-sm-2  col-sm-1_7">
									<select class="form-control" style="margin-right: -0.7rem;" name="bckType" id="bckType">
										<option value="0"> <spring:message code="eXperDB_backup.msg28" /></option>
										<option value="3"> Backup Full</option>
										<option value="4"> Backup Incremental</option>
										<option value="5"> Backup Verify</option>
									</select>
								</div>
								<div class="input-group mb-2 mr-sm-2  col-sm-1_7">
											...
											<table id="bckHistoryList" class="table table-hover table-striped system-tlb-scroll" style="width:100%; align:dt-center;">
												<thead>
													<tr class="bg-info text-white">
														...
														<th width="80"><spring:message code="eXperDB_backup.msg29" /></th>															
