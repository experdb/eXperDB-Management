			...
			<table class="write">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<select class="select" id="cipherAlgorithmCode" name="cipherAlgorithmCode">
					...
					<tr>
						...
						<td><select class="select" id="binUid" name="binUid">
								<c:forEach var="binUid" items="${binUid.data}" varStatus="status">
									<option value="<c:out value="${binUid.resourceName}"/>"><c:out value="${binUid.resourceName}"/></option>
								</c:forEach> 
						</select></td>
					</tr>
					<tr>
