...
<div class="col-lg-6 grid-margin stretch-card" id="trans_monitoring_target_info" style="display:none;">
									 			...
									 			<table id="tarTopicListTable" class="table table-hover system-tlb-scroll" style="width:100%;">
													<thead>
														<tr class="bg-info text-white">
															...
															<th width="500" class="dt-center" ><spring:message code="eXperDB_CDC.topic_nm" /></th>	
														</tr>
													</thead>
												</table>
											</div>
	...
	<!-- 			</div> -->
			...
			<div id="tar_connect_nvl" class="col-md-12 col-xl-12 justify-content-center" style="display:none;">
