...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
    <div id="pop_layer_dump" class="pop-layer">
		<div class="pop-container" style="padding: 0px;">
			<div class="pop_cts" style="width: 35%; height: 740px; overflow: auto; padding: 20px; margin: 0 auto; min-height:0; min-width:0; margin-top: 10%" id="workinfo">
				...
				<table class="list" style="border:1px solid #b8c3c6;">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: left; text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" id="d_wrk_exp"></td>
						</tr>	
						<tr>
