...
<%
	...
	*/
%>
<div class="modal fade" id="pop_layer_fix_rslt_reg" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1060;">
				...
				<div class="card" style="margin-top:10px;border:0px;">
					<div class="card-body">
						<form class="cmxform" id="rsltMsgInfoForm">
							<input type="hidden" name="rst_fix_rslt_view_gbn"  id="rst_fix_rslt_view_gbn">
								...
								<div class="form-group">
									...
									<div class= "row">
										<div class="col-sm-12">
											...
											<input type="hidden" name="rst_exe_sn_r" id="rst_exe_sn_r">
										</div>
									</div>
								</div>
