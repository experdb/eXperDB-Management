...
<div class="modal fade" id="pop_layer_config_view" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:9999;">
						...
						<form class="cmxform" id="configForm">
							...
							<fieldset>
								...
								<div class="top-modal-footer" style="text-align: center !important; margin: -10px 0 0 -10px;" >
									<button type="button" class="btn btn-light" onclick="fn_proxyConfigViewPopcl();"><spring:message code="common.close"/></button>
								</div>
							</fieldset>
						</form>
					</div>
