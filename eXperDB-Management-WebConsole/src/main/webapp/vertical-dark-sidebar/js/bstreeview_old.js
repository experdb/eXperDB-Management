...
/*                    	.attr('style', 'padding-left:' + leftPadding)*/
	               ...
	               jQuery("a[aria-controls='" + _this.itemIdPrefix + node.nodeId + "']").click();
                    ...
                    if (node.nodes) {
                    	treeItem = $(templates.treeviewItem)
        				.attr('style', 'padding-left:' + leftPadding)
        				.attr('id', node.id + "c");
                    } else {
                    ...
                    //url 체크
                    if (node.nodes) {
                    	treeItem.attr('href', "#" + _this.itemIdPrefix + node.nodeId);
                    } else {
                    	treeItem.attr('href', node.url);
                    	
                    	treeItem.attr('onclick', "fn_GoLink('"+ node.id + "')");
            	...
            	console.log("3====" + parentElement.html());
            });
        }
    });
