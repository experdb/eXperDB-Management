...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"처음",sLast:"끝",sNext:common_next,sPrevious:common_preview},sEmptyTable:"Data does not exist.",sInfo:	common_total+" _TOTAL_ (_START_ / _END_)",sInfoEmpty:common_total+" 0 (0 / 0)",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ 단위",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
