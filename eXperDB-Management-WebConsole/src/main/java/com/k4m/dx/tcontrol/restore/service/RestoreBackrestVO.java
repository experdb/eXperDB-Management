...
public class RestoreBackrestVO {
	private int rownum;
	private int idx;
	...
	public String getAsis_flag() {
		return asis_flag;
	}

	public void setAsis_flag(String asis_flag) {
		this.asis_flag = asis_flag;
	}
	...
	public String getRestore_svr_nm() {
		return restore_svr_nm;
	}

	public void setRestore_svr_nm(String restore_svr_nm) {
		this.restore_svr_nm = restore_svr_nm;
	}
