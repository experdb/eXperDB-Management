...
public class WrkExeVO {
	...
	public String getBck_file_nm() {
		return bck_file_nm;
	}

	public void setBck_file_nm(String bck_file_nm) {
		this.bck_file_nm = bck_file_nm;
	}
