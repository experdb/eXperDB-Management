...
public class ProxyClientTranCodeType {
	...
	public static final String PsP012 = "PsP012";	// proxy 서버 확인
	public static final String PsP013 = "PsP013";	// 백업 파일 삭제
	public static final String PsP014 = "PsP014";	// Scale In 시 haproxy.cfg 수정
