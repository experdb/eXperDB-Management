...
INSERT INTO T_SYSDTL_C(GRP_CD, SYS_CD, SYS_CD_NM, USE_YN, FRST_REGR_ID, FRST_REG_DTM, LST_MDFR_ID, LST_MDF_DTM ) VALUES('TC0038', 'TC003805', '직접', 'Y', 'ADMIN', clock_timestamp(), 'ADMIN', clock_timestamp());
