...
-- admin유저 Backup 메뉴 권한 삭제     
       
-- experdb유저 BnR 설정 메뉴 권한 삭제
       
-- experdb Backup 메뉴 권한 삭제     
              
-- Storage설정 화면 접근이력코드 삭제

-- Storage 등록 팝업 화면 접근이력코드 삭제

-- Storage 수정 팝업 화면 접근이력코드 삭제


-- 백업 정책설정 화면 접근이력코드 삭제

-- 대상서버 등록 팝업 접근이력코드 삭제

-- 대상서버 수정 팝업 접근이력코드 삭제

-- 풀백업 정책 등록/수정 팝업 접근이력코드 삭제

-- 증분백업 등록/수정 팝업 접근이력코드 삭제

-- 백업이력 관리 화면 접근이력코드 삭제

-- 복구이력 관리 화면 접근이력코드 삭제
