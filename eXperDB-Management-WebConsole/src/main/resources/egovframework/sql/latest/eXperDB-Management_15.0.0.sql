...
INSERT INTO T_SYSDTL_C(GRP_CD, SYS_CD, SYS_CD_NM, USE_YN, FRST_REGR_ID, FRST_REG_DTM, LST_MDFR_ID, LST_MDF_DTM, SYS_CD_NM_EN ) VALUES('TC0001', 'DX-T0183', 'Backrest 백업 상세조회 팝업', 'Y', 'ADMIN', clock_timestamp(), 'ADMIN', clock_timestamp());
