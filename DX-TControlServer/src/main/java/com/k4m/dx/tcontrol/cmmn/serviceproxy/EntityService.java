...
public class EntityService {
	...
	public EntityService(String restIp, int restPort) {
		this.restIp = restIp;
	...
	public static void main(String[] args) throws Exception {
		...
		EntityService entityService = new EntityService(ip, port);
		entityService.loginTest();
	}
	
	private void loginTest() throws Exception {
		
		EntityService api = new EntityService(restIp, restPort);
