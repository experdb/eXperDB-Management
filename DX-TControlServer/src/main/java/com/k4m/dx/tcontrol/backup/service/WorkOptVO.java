...
public class WorkOptVO {
	private int wrk_id;
	private int opt_sn;
	private String grp_cd;
	private String opt_cd;
	private String bck_opt_val;
	...
	public int getOpt_sn() {
		return opt_sn;
	}
	public void setOpt_sn(int opt_sn) {
		this.opt_sn = opt_sn;
	}
	...
	public String getBck_opt_val() {
		return bck_opt_val;
	}
	public void setBck_opt_val(String bck_opt_val) {
		this.bck_opt_val = bck_opt_val;
	}
