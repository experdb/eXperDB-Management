...
//새창 여는 함수
function uf_newWin(url, winName, sizeW, sizeH, opt,autoclose)
{
	var nLeft  = screen.width/2 - sizeW/2 ;
	var nTop  = screen.height/2 - sizeH/2 ;
	var dftOpt = ",toolbar=no,menubar=no,location=no,scrollbars=yes,status=no,resizable=no";
	var opt = opt || dftOpt;
	if (autoclose == null){autoclose=true;}  
	var objwin = window.open(url, winName, "left=" + nLeft + ",top=" +  nTop + ",width=" + sizeW + ",height=" + sizeH  + opt );
...
function uf_hsplitter_init() { 
	document.getElementById('div_leftbox').style.cssText = "background:url('../images/menu/img_leftmenubg_hsplitter.gif') no-repeat left top;";
	document.getElementById('footer').style.cssText = "background:#d9d9d9 url('../images/menu/img_footerbg.gif') no-repeat left top;";
}
...
function uf_lefthsplitter_open () {
	...
	//document.getElementById('ft_link').style.cssText = "display:none;";
	document.getElementById('footer').style.cssText = "background:#d9d9d9 url('../images/menu/img_footerbg_splitter.gif') no-repeat left top";
	document.getElementById('header').style.cssText = "z-index:5;";
	document.getElementById('container').style.cssText = "padding-left:20px;background:url('../images/menu/img_leftmenubg_hsplitter.gif') no-repeat left top;height:auto;z-index:650;";
...
function uf_lefthsplitter_close () {
	...
	//document.getElementById('ft_link').style.cssText = "display:block;";
	
	//document.getElementById('footer').style.cssText = "background:#d9d9d9 url('../images/menu/img_footerbg.gif') no-repeat left top;";
	$('#footer').css("cssText", "background:#d9d9d9 background:url('../images/menu/img_footerbg.gif') no-repeat left top");
...
function uf_main_open () {
	...
	document.getElementById('ft_link').style.cssText = "display:none;";
	document.getElementById('footer').style.cssText = "background:#d9d9d9 url('../images/menu/img_footerbg_splitter.gif') no-repeat left top;";
	document.getElementById('header').style.cssText = "z-index:5;background:url('../images/menu/top_bg_splitter.gif') repeat-x left top;";
	document.getElementById('container').style.cssText = "margin:0 0 0 0px;padding-left:20px;background:url('../images/menu/img_leftmenubg_hsplitter.gif') no-repeat left top;height:auto;z-index:650;";
...
function uf_ifrmShow(ifrmUrl, ifrmWidth, ifrmHeight, ifrmTop) {

	var nLeft  = document.body.clientWidth/2 - ifrmWidth/2 -120;
	
	if ( nLeft < 0 ) {	nLeft  = nLeft + 120 ; }
...
/* 폴더 Toggle */
function uf_menuInit (firstmenu,menunum) {
	for (i=1; i<=menunum ; i++)
	{			
		$("#submenu" + i).css("display","none");			
	}
	$("#submenu"+ firstmenu).css("display","block");
}
...
$(document).ready(function(){
	$(".btn_allmenu").toggle(
		function(){
			$(".all_menu_layer").css("display","block");
		},
		function(){
