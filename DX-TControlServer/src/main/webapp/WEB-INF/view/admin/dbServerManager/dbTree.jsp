...
function fn_reg_popup(){
	window.open("/popup/dbServerRegForm.do?flag=tree","dbServerRegPop","location=no,menubar=no,scrollbars=yes,status=no,width=950,height=613");
}
...
function fn_regRe_popup(){
	...
	if (datas.length == 1) {
		...
		window.open("/popup/dbServerRegReForm.do?db_svr_id="+db_svr_id+"&flag=tree","dbServerRegRePop","location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,width=950,height=638");
	} else {
