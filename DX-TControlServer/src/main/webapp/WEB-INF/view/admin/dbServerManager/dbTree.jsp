...
function fn_regRe_popup(){
	...
	if (datas.length == 1) {
		...
		window.open("/popup/dbServerRegReForm.do?db_svr_id="+db_svr_id+"&flag=tree","dbServerRegRePop","location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,width=950,height=613");
	} else {
