					...
					<div class="m_info_lt">
						...
						<ul>
							...
							<li>
								...
								<p class="state_num c2 double">5</p>
						...
						<table class="list">
							...
							<thead>
								<tr>
									...
									<th scope="col" rowspan="2">감사설정</th>
							...
							<tbody>
								<tr>
									...
									<td>20</td>
									<td>실행</td>
									<td><span class="work_state"><img src="../images/ico_state_03.png" alt="Running" /></span>Running</td>
									<td>5</td>
									<td>5</td>
								</tr>
								<tr>
									...
									<td>20</td>
									<td>실행</td>
									<td><span class="work_state"><img src="../images/ico_state_07.png" alt="Stop" /></span>Stop</td>
									<td>5</td>
									<td>5</td>
								</tr>
								<tr>
									...
									<td>20</td>
									<td>실행</td>
									<td><span class="work_state"><img src="../images/ico_state_08.png" alt="Not install" /></span>Not install</td>
									<td>5</td>
									<td>5</td>
								</tr>
							</tbody>
