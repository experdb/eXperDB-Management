...
<div class="contsBody">
	...
	<div class="bbsDetail">
		...
		<tr>
			...
			<td colspan="3">
			<input type="text"  size="10" maxlength="10"  name="grp_cd"  id="grp_cd" />
			</td>
		</tr> 
 		...
 		<tr>
			...
			<td>				
				<input type="text"  size="60" maxlength="60"  name="grp_cd_nm"  id="grp_cd_nm"/>
			</td>    
		</tr> 
		...
		<tr> 
			...
			<td>
				<textarea rows="3" cols="60" id="grp_cd_exp" name="grp_cd_exp"></textarea>
			</td>
		</tr> 
