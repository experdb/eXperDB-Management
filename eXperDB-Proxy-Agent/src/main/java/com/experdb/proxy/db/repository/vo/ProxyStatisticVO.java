...
public class ProxyStatisticVO {
	...
	private long pry_exe_status_sn;
	...
	private String db_con_addr_chk;
	...
	public long getPry_exe_status_sn() {
		return pry_exe_status_sn;
	}
	public void setPry_exe_status_sn(long pry_exe_status_sn) {
		this.pry_exe_status_sn = pry_exe_status_sn;
	}
	public String getDb_con_addr_chk() {
		return db_con_addr_chk;
	}
	public void setDb_con_addr_chk(String db_con_addr_chk) {
		this.db_con_addr_chk = db_con_addr_chk;
	}
