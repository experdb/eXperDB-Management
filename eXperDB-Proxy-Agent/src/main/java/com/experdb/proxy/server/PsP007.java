...
public class PsP007 extends SocketCtl{
	...
	public PsP007(Socket socket, BufferedInputStream is, BufferedOutputStream	os) {
		this.client = socket;
		this.is = is;
		this.os = os;
	}
	...
	public void execute(String strDxExCode, JSONObject jObj) throws Exception {
		...
		try {
			...
			outputObj = fromJettisonToSimple(service.getAgentInterface(fromSimpleToJettison(jObj)));
